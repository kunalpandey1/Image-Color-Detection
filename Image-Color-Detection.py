...
#Label
Label(root,width=120,height=10,bg="#eb6434").pack()
...
Label(frame,image=logo,bg="#fff").place(x=10,y=10) # here frame is a parent i=of label that is why we have written here frame instead of root
